...
func _ready() -> void:
	...
	var width = int(get_viewport().get_visible_rect().size[0]/2)
	
	var height = int(get_viewport().get_visible_rect().size[1]/2)-150
...
func logistics():
	...
	if logistics_ready:
		#print("New Round in Squash: ", assets)	
...
func _on_action_timer_timeout() -> void:
	...
	pass # moneyReplace with function body.
